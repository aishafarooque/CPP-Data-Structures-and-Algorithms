...
if [ -f Subsequence ]; then
    rm Subsequence
fi
g++ -std=c++11 *.cpp -o Subsequence
...
./Subsequence "input=input11.txt;output=output11.txt" 1>1.stdcout 2>1.stderr
...
# For test case 2
./Subsequence "input=input12.txt;output=output12.txt" 1>1.stdcout 2>1.stderr
...
# For test case 3
./Subsequence "input=input13.txt;output=output13.txt" 1>1.stdcout 2>1.stderr
...
# For test case 4
./Subsequence "input=input14.txt;output=output14.txt" 1>1.stdcout 2>1.stderr
...
# For test case 5
./Subsequence "input=input15.txt;output=output15.txt" 1>1.stdcout 2>1.stderr
...
# For test case 6
./Subsequence "input=input16.txt;output=output16.txt" 1>1.stdcout 2>1.stderr
